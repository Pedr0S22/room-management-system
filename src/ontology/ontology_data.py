...
def populate_system():
    ...
    agent.add_teacher("Ana Sousa", 103, ["SD", "ES"])
    agent.add_teacher("Bruno Costa", 104, ["IPRP"])
    agent.add_teacher("Carla Dias", 105, ["PLN", "VD", "PA"])
    agent.add_teacher("Diogo Silva", 106, ["AED", "OC"])
    agent.add_teacher("Elena Rossi", 107, ["CM", "EA"])
    ...
    # LDM Year 1
    agent.add_student("Eduardo Martins", 2023005, "LDM", 1, ["IPRP", "AMII"])
